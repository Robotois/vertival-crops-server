...
${OBJECTDIR}/Modules/IOModule.o: Modules/IOModule.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modules/IOModule.o Modules/IOModule.cpp
...
${OBJECTDIR}/tests/test.o: tests/test.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/test.o tests/test.cpp
